      ...
      <section id='content' style={{ fontFamily: 'Times New Roman' }}>
        <Row>
          <Col sm={12} xs={12} lg={6} md={6}>
            <Card>
              <Card.Header>Sentences</Card.Header>
              <Card.Body>
        ...
        <Modal.Body>
          <Row>
            <Card className='my-3'>
              ...
              >
                Thank you for contributing to this project. Videos collected on
                this platform will be used exclusively for the SignSay project.
                If you have additional requirements about your contribution,
                email us at catherineburnham68@gmail.com. <br />
                ...
                <ol>
                  ...
                  <li>
                    Read and understand the sentence. We realize some sentences
                    could be problematic. You can skip, check the next one.
                  </li>
                  <li>
                    Set up your camera. Click the button on the right below to
                    start recording your version of the selected sentence in
                    Sign Language. You will be requested to allow the website to
                    access your camera. Please allow to proceed. You can cancel
                    and restart recording. Once you are satisfied, click submit.
                  </li>
                  <li>
                    You can record the signs offline and use the upload button
                    to upload your video. Click submit when you're comfortable.
                  </li>
                  <li>
